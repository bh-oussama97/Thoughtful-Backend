...
namespace Thoughtful.Dal.Migrations
{
    ...
    [Migration("20250408093209_ChangeArticleCategoryRelationArticleAuthorRelation")]
    partial class ChangeArticleCategoryRelationArticleAuthorRelation
    {
            ...
            modelBuilder.Entity("Thoughtful.Domain.Model.Article", b =>
                {
                    b.HasOne("Thoughtful.Domain.Model.Author", "Author")
                        .WithOne("Article")
                        .HasForeignKey("Thoughtful.Domain.Model.Article", "AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Thoughtful.Domain.Model.Category", "Category")
                        .WithMany("Articles")
